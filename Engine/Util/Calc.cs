...
{
    /// <summary>
    /// Collection of static methods for utility purposes<br/>
    /// Imported from Monocle engine<br/>
    /// Most unused<br/>
    /// </summary>
    public static class Calc
    {
        ...
        /// <summary>
        /// Returns a random float between min (inclusive) and max (exclusive)<br/>
        /// </summary>
        /// <param name="random"></param>
        /// <param name="min"></param>
        /// <param name="max"></param>
        ...
        /// <summary>
        /// Returns a random Vector2, and x- and y-values of which are between min (inclusive) and max (exclusive)<br/>
        /// </summary>
        /// <param name="random"></param>
        /// <param name="min"></param>
        /// <param name="max"></param>
        ...
        /// <summary>
        /// Read positive-integer CSV with some added tricks.<br/>
        /// Use - to add inclusive range. Ex: 3-6 = 3,4,5,6<br/>
        /// Use * to add multiple values. Ex: 4*3 = 4,4,4<br/>
        /// </summary>
        ...
        /// <summary>
        /// Logs each item in the parameters<br/>
        /// </summary>
        ...
        /// <summary>
        /// Logs each item in <paramref name="collection"/><br/>
        /// </summary>
        ...
        /// <summary>
        /// Logs the properties of <paramref name="obj"/><br/>
        /// </summary>
        ...
        /// <summary>
        /// Starts a timer (only one timer can be active at a time)<br/>
        /// </summary>
        ...
        /// <summary>
        /// Stops the timer and logs the time elapsed<br/>
        /// </summary>
        ...
        /// <summary>
        /// Creates delegate of type <typeparamref name="T"/> from <paramref name="method"/> of <paramref name="obj"/><br/>
        /// </summary>
        /// <typeparam name="T"> The delegate type </typeparam>
        /// <param name="obj"> The object to get the method from </param>
        /// <param name="method"> The method name to create a delegate from </param>
        /// <returns></returns>
