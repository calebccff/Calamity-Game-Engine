...
namespace TestShader
{
    ...
    class DemoSolid2 : Solid
    {
        ...
        public DemoSolid2(Texture2D texture, int x_count, int y_count, Effect? shader = null) : base(texture)
        {
        ...
        /// <summary>
        /// Update,<br/>
        /// Moves the sprite back and forth in the y direction<br/>
        /// </summary>
        /// <param name="gameTime"></param>
        public override void Update(GameTime gameTime)
        {
            Move(0, Math.Sign(Math.Sin(gameTime.TotalGameTime.TotalSeconds)));
